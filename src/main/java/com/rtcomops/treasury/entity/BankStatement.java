...
/**
 * Entity representing an imported bank statement.
 *
 * <p>This entity maps to the treasury.bank_statements table and contains
 * information about bank statements imported for reconciliation.</p>
 *
...
public class BankStatement implements Persistable<UUID> {
    ...
    public BankStatement markNotNew() {
        this.isNew = false;
        return this;
    }
}
