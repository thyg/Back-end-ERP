...
public class CheckDepositController {
    ...
    private final CheckDepositUseCase checkDepositUseCase;

    public CheckDepositController(CheckDepositUseCase checkDepositUseCase) {
        this.checkDepositUseCase = checkDepositUseCase;
    }
    ...
    public Flux<CheckDepositResponse> getAllDeposits() {
        ...
        return checkDepositUseCase.findAll();
    }
    ...
    public Mono<ResponseEntity<CheckDepositResponse>> getDepositById(@PathVariable UUID id) {
        ...
        return checkDepositUseCase.findById(id).map(ResponseEntity::ok);
    }
    ...
    public Flux<CheckDepositResponse> getDepositsByAccount(
        ...
        return checkDepositUseCase.findByBankAccountId(accountId);
    }
    ...
    public Flux<CheckDepositResponse> getUnreconciledDeposits() {
        ...
        return checkDepositUseCase.findUnreconciled();
    }
    ...
    public Mono<ResponseEntity<CheckDepositResponse>> createDeposit(
        ...
        return checkDepositUseCase.createDeposit(request)
    ...
    public Mono<ResponseEntity<CheckDepositResponse>> confirmDeposit(
        ...
        return checkDepositUseCase.confirmDeposit(id, depositDate)
    ...
    public Mono<ResponseEntity<CheckDepositResponse>> cashDeposit(
        ...
        return checkDepositUseCase.cashDeposit(id, cashedDate)
            .map(ResponseEntity::ok);
    }
    ...
    public Mono<ResponseEntity<Void>> cancelDeposit(
        ...
        return checkDepositUseCase.cancelDeposit(id)
