...
/**
 * Persistence entity representing a banking institution.
 *
 * <p>This entity maps to the treasury.banks table and contains
 * all R2DBC annotations for database mapping.</p>
 *
...
public class BankEntity implements Persistable<UUID> {
