package com.rtcomops.treasury.domain.exception;

/**
 * Exception thrown when a business rule is violated.
 *
 * <p>This exception should be thrown when a business operation
 * cannot be completed due to a violation of business logic.</p>
 *
