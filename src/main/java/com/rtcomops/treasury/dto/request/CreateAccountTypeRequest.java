 ...
 * when creating an account type record.</p>
 *
...
public class CreateAccountTypeRequest {
     ...
     */
    @NotBlank(message = "Le code du type de compte est requis")
    ...
    /**
     * Whether the account type is active. Defaults to true if not specified.
     */
