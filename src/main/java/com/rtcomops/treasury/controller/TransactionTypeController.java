...
import com.rtcomops.treasury.service.TransactionTypeService;
...
public class TransactionTypeController {
     ...
     *
     * @param transactionTypeService the transaction type service
     */
    ...
    public Flux<TransactionTypeResponse> getAllTransactionTypes(
        ...
        return transactionTypeService.findAll(activeOnly);
    }
    ...
    public Flux<TransactionTypeResponse> getTransactionTypesByCategory(
        ...
        return transactionTypeService.findByCategory(category);
    }
    ...
    public Mono<ResponseEntity<TransactionTypeResponse>> createTransactionType(
        ...
        return transactionTypeService.create(request)
    ...
    public Mono<ResponseEntity<TransactionTypeResponse>> updateTransactionType(
        ...
        return transactionTypeService.update(id, request)
            .map(ResponseEntity::ok);
    }
